...
import com.shutafin.processors.SessionAnnotationsResponseBeanPostProcessor;
...
public class ApplicationContextConfiguration {
    ...
    @Bean
    public SessionAnnotationsResponseBeanPostProcessor sessionAnnotationsResponseBeanPostProcessor(){
        return new SessionAnnotationsResponseBeanPostProcessor();
    }

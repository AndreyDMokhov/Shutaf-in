...
import com.shutafin.persistence.repository.ImageStorageRepository;
import com.shutafin.persistence.repository.account.UserImageRepository;
...
public class UserImageServiceImpl implements UserImageService {
    ...
    private ImageStorage createImageBackup(UserImage userImage, String image) {
        ...
        Long storedImageId = imageStorageRepository.save(imageStorage).getId();

...
//        Mockito.when(userImageService.getCompressedUserImage(validUser, VALID_USER_IMAGE_ID))
//                .thenReturn(validUserImage);
//        Mockito.when(userImageService.getCompressedUserImage(validUser, INVALID_USER_IMAGE_ID))

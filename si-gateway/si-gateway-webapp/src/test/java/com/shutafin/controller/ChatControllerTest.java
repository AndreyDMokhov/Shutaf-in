...
public class ChatControllerTest extends BaseTestImpl {
    ...
    public void setUp(){
        ...
        Mockito.when(sessionManagementService.findUserWithValidSession(INVALID_SESSION_ID)).thenReturn(null);
        ...
        Mockito.when(chatInfoService.getListChats(Mockito.anyLong())).thenReturn(listChatWithUsersListDTO);
        Mockito.when(chatInfoService.getListMessages(Mockito.anyLong(),Mockito.anyLong())).thenReturn(listChatMessage);
        Mockito.when(chatAuthorizationService.findAuthorizedChat(Mockito.anyLong(), Mockito.anyLong())).thenReturn(new Chat());
        Mockito.when(chatAuthorizationService.findAuthorizedChatUser(Mockito.anyLong(), Mockito.anyLong())).thenReturn(new ChatUser());
        ...
        Mockito.when(userMatchService.findMatchingUsers(validUser)).thenReturn(new ArrayList<>());
    }
